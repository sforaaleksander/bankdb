...
public class Customers {
    public static final String[] MALE_NAMES = {"Piotr", "Krzysztof", "Andrzej", "Tomasz", "Jan", "Paweł", "Michał", "Marcin", "Stanisław", "Jakub", "Adam", "Marek", "Łukasz", "Grzegorz", "Mateusz", "Wojciech", "Mariusz", "Dariusz", "Zbigniew", "Jerzy", "Maciej", "Rafał", "Robert", "Kamil", "Józef", "Jacek", "Dawid", "Tadeusz", "Ryszard", "Szymon"};
    ...
    public static final String[] FEMALE_NAMES = {"Anna", "Maria", "Katarzyna", "Małgorzata", "Agnieszka", "Barbara", "Ewa", "Krystyna", "Elżbieta", "Magdalena", "Joanna", "Zofia", "Aleksandra", "Monika", "Teresa", "Danuta", "Natalia", "Karolina", "Marta", "Julia", "Beata", "Dorota", "Janina", "Jadwiga", "Halina", "Jolanta", "Alicja", "Irena", "Grażyna", "Iwona"};
